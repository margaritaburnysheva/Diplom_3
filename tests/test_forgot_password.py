...
class TestForgotPassword:
    ...
    def test_switch_to_forgot_password_page(self, driver):
        ...
        login_page.check_click_to_link_password_recovery()
    ...
    def test_add_email_and_click_to_recovery_button(self, driver):
        forgot_password_page = ForgotPasswordPage(driver)
        forgot_password_page.check_add_email_and_click_to_recovery_button()
    ...
    def test_click_to_show_password_icon(self, driver):
        forgot_password_page = ForgotPasswordPage(driver)
        forgot_password_page.input_email_and_click_button_recovery()
        reset_password_page = ResetPasswordPage(driver)
        result = reset_password_page.click_to_show_password_icon()
