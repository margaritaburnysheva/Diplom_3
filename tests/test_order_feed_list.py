...
class TestOrderFeedList:
    ...
    def test_click_to_order_and_view_details(self, driver):
        ...
        result = order_feed_list_page.check_click_to_order_and_view_details(driver)
    ...
    def test_check_orders_from_history_on_order_feed_list(self, driver, login_user):
        ...
        order_feed_list_page = OrderFeedListPage(driver)
        result_history = personal_account_page.get_order_from_history(driver)
        result_list = order_feed_list_page.get_orders_numbers_from_feed_list(driver)
    ...
    def test_check_total_counter_increases(self, driver, login_user):
        order_feed_list_page = OrderFeedListPage(driver)
        first = order_feed_list_page.check_total_order_counter(driver)
        main_page = MainPage(driver)
        main_page.check_create_order(driver)
        second = order_feed_list_page.check_total_order_counter(driver)
    ...
    def test_check_today_counter_increases(self, driver, login_user):
        order_feed_list_page = OrderFeedListPage(driver)
        first = order_feed_list_page.check_today_order_counter(driver)
        main_page = MainPage(driver)
        main_page.check_create_order(driver)
        second = order_feed_list_page.check_today_order_counter(driver)
        assert int(second) > int(first), \
    ...
    def test_check_order_in_processing_list(self, driver, login_user):
        ...
        main_page.check_create_order(driver)
        order_feed_list_page = OrderFeedListPage(driver)
        result = order_feed_list_page.get_order_list_processing(driver)
